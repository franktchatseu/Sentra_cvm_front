  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex justify-between pt-6 border-t border-gray-200">
        <button
          onClick={onPrev}
          className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-[#DAD7CD] text-[#344E41] rounded-xl font-semibold hover:bg-gray-50 transition-all duration-200"
        >
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-start space-x-3 cursor-pointer">
                <input
                  ...
                  onChange={(e) => setConfig({ type: e.target.value as any, control_group_method: 'fixed_percentage', percentage: 23 })}
                  className="mt-1 w-4 h-4 text-[#588157] border-gray-300 focus:ring-[#588157]"
                />
                <div>
              ...
              <div className="space-y-3">
                <label className="flex items-start space-x-3 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => setConfig({ ...config, control_group_method: e.target.value as any, percentage: 23 })}
                    className="mt-1 w-4 h-4 text-[#588157] border-gray-300 focus:ring-[#588157]"
                  />
                  <div>
                ...
                <label className="flex items-start space-x-3 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => setConfig({ ...config, control_group_method: e.target.value as any, fixed_number: 10000 })}
                    className="mt-1 w-4 h-4 text-[#588157] border-gray-300 focus:ring-[#588157]"
                  />
                  <div>
                ...
                <label className="flex items-start space-x-3 cursor-pointer">
                  <input
                    ...
                    onChange={(e) => setConfig({ ...config, control_group_method: e.target.value as any, confidence_level: 95, margin_of_error: 99 })}
                    className="mt-1 w-4 h-4 text-[#588157] border-gray-300 focus:ring-[#588157]"
                  />
                  <div>
