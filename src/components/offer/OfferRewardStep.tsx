...
import { Plus, Trash2, Gift, ArrowLeft, ArrowRight, Edit, X } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <div className="w-16 h-16 bg-gradient-to-r from-yellow-100 to-amber-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
          <Gift className="w-8 h-8 text-yellow-600" />
        </div>
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Offer Rewards</h2>
