...
import { ConfigurationPageConfig, ConfigurationItem } from '../components/GenericConfigurationPage';
...
const hardcodedLineOfBusiness: ConfigurationItem[] = [
    {
        id: 1,
        name: 'GSM',
        description: 'Global System for Mobile Communications - Mobile network services',
        created_at: '2024-01-15T10:30:00Z',
        updated_at: '2024-01-20T14:45:00Z'
    },
    {
        id: 2,
        name: 'Internet',
        description: 'Internet and broadband services for residential and business customers',
        created_at: '2024-01-10T09:15:00Z',
        updated_at: '2024-01-18T16:20:00Z'
    },
    {
...
export const campaignObjectivesConfig: ConfigurationPageConfig = {
    ...
    deleteConfirmMessage: (name: string) => `Are you sure you want to delete "${name}"? This action cannot be undone.`,
...
export const teamRolesConfig: ConfigurationPageConfig = {
    ...
    deleteConfirmMessage: (name: string) => `Are you sure you want to delete the role "${name}"? This action cannot be undone.`,
    deleteSuccessMessage: (name: string) => `Role "${name}" has been deleted successfully.`,
