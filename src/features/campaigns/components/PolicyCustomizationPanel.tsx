...
export default function PolicyCustomizationPanel({ 
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => onConfigChange({ ...timeConfig, startTime: e.target.value })}
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => onConfigChange({ ...timeConfig, endTime: e.target.value })}
                            className={`${components.input.default} w-full px-3 py-2`}
                        />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select
                            ...
                            onChange={(e) => onConfigChange({ ...maxConfig, type: e.target.value as 'daily' | 'weekly' | 'monthly' })}
                            className={`${components.input.default} w-full px-3 py-2`}
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => onConfigChange({ ...maxConfig, maxCount: parseInt(e.target.value) || 1 })}
                            className={`${components.input.default} w-full px-3 py-2`}
                        />
                    </div>
                </div>
        ...
        return (
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    <h5 className={`${tw.body} font-medium ${tw.textPrimary}`}>DND Categories</h5>
                    <button
                        type="button"
                        onClick={() => {
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            onConfigChange({ ...dndConfig, categories: newCategories });
                                        }}
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <select
                            ...
                            onChange={(e) => onConfigChange({ ...vipConfig, action: e.target.value as 'include' | 'exclude' })}
                            className={`${components.input.default} w-full px-3 py-2`}
                        >
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => onConfigChange({ ...vipConfig, priority: parseInt(e.target.value) || 1 })}
                            className={`${components.input.default} w-full px-3 py-2`}
                        />
                    </div>
                </div>
    ...
    return (
        <div className="space-y-4">
            ...
            {policy.type === 'maximumCommunication' && renderMaxCommunicationCustomization()}
