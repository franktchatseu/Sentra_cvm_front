...
import { Users, Plus, Target, Edit, Trash2, Settings, GripVertical, AlertCircle, Award, TestTube, RotateCw, Layers } from 'lucide-react';
...
export default function AudienceConfigurationStep({
  ...
  const handleSegmentCreated = (segment: Segment) => {
    ...
    let campaignSegment: CampaignSegment = {
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          >
            <div className="flex flex-col items-center text-center space-y-2">
              <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                formData.campaign_type === 'multiple_target_group' ? 'bg-[#588157]' : 'bg-[#DAD7CD]'
              }`}>
                <Users className={`w-6 h-6 ${
                  formData.campaign_type === 'multiple_target_group' ? 'text-white' : 'text-[#344E41]'
                }`} />
              </div>
          ...
          >
            <div className="flex flex-col items-center text-center space-y-2">
              <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                formData.campaign_type === 'champion_challenger' ? 'bg-[#588157]' : 'bg-[#DAD7CD]'
              }`}>
                <Award className={`w-6 h-6 ${
                  formData.campaign_type === 'champion_challenger' ? 'text-white' : 'text-[#344E41]'
                }`} />
              </div>
          ...
          >
            <div className="flex flex-col items-center text-center space-y-2">
              <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                formData.campaign_type === 'ab_test' ? 'bg-[#588157]' : 'bg-[#DAD7CD]'
              }`}>
                <TestTube className={`w-6 h-6 ${
                  formData.campaign_type === 'ab_test' ? 'text-white' : 'text-[#344E41]'
                }`} />
              </div>
          ...
          >
            <div className="flex flex-col items-center text-center space-y-2">
              <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                formData.campaign_type === 'round_robin' ? 'bg-[#588157]' : 'bg-[#DAD7CD]'
              }`}>
                <RotateCw className={`w-6 h-6 ${
                  formData.campaign_type === 'round_robin' ? 'text-white' : 'text-[#344E41]'
                }`} />
              </div>
          ...
          >
            <div className="flex flex-col items-center text-center space-y-2">
              <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${
                formData.campaign_type === 'multiple_level' ? 'bg-[#588157]' : 'bg-[#DAD7CD]'
              }`}>
                <Layers className={`w-6 h-6 ${
                  formData.campaign_type === 'multiple_level' ? 'text-white' : 'text-[#344E41]'
                }`} />
              </div>
