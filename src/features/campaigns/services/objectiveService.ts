...
class ObjectiveService {
  ...
  async createObjective(request: CreateObjectiveRequest): Promise<CampaignObjective> {
  ...
  async updateObjective(id: number, request: Partial<CreateObjectiveRequest>): Promise<CampaignObjective> {
