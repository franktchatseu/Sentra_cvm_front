            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
                {isLoading ? (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center justify-between mb-2">
                                        <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold border ${getActionBadge(entry.action)}`}>
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className={`text-sm ${tw.textMuted}`}>This campaign has no approval history yet.</p>
                    </div>
                )}
            </div>
        </div>
