      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
          ...
          <div className="p-4 space-y-3">
            {previewTitle && (
              <div>
                ...
                <p className="text-base font-semibold text-gray-900">{previewTitle}</p>
              </div>
            )}

            <div>
              {previewTitle && <p className="text-xs text-gray-500 font-medium mb-1">MESSAGE</p>}
          ...
          <div className="px-4 py-2 bg-gray-50 border-t">
            <p className="text-xs text-gray-500">
              Preview with sample data: {Object.keys(sampleData).length > 0 ? Object.keys(sampleData).join(', ') : 'No sample data'}
            </p>
          </div>
      </div>
    </div>
